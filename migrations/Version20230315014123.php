 ...
 */
final class Version20230315014123 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE invoice_lines (id INT AUTO_INCREMENT NOT NULL, invoice_id INT NOT NULL, description VARCHAR(255) NOT NULL, quantity INT NOT NULL, amount NUMERIC(10, 0) NOT NULL, vat_amount NUMERIC(10, 0) NOT NULL, total_vat NUMERIC(10, 0) NOT NULL, INDEX IDX_72DBDC232989F1FD (invoice_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
